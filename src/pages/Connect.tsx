      ...
      <div className="mt-10 flex flex-col items-center">
        ...
        <div className="flex flex-col items-center gap-6">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="w-full min-w-[280px] rounded-full bg-[#000000] px-10 py-4 text-sm text-[#FFFFFF] transition-all duration-300 hover:scale-105 dark:bg-[#FFFFFF] dark:text-[#000000]"
          >
            Personal Instagram
          </a>
          <a
